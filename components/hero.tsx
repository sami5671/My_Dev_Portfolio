        ...
        >
          ...
          <motion.div variants={itemVariants} className="space-y-6">
            <motion.div variants={itemVariants} className="space-y-2">
              ...
              <p className="text-xl sm:text-2xl text-primary/80 font-semibold">MERN Stack Developer</p>
            </motion.div>

            <motion.p variants={itemVariants} className="text-foreground/70 text-lg leading-relaxed">
              Building scalable, role-based, and payment-integrated web platforms. I design and build full-stack web
              applications using React, Node.js, and MongoDB. Experienced in secure payment integrations, role-based
            ...
            <motion.div variants={itemVariants} className="flex flex-col sm:flex-row gap-4 pt-4">
              <Link href="#projects" className="flex-1">
                <Button className="w-full bg-gradient-to-r from-primary to-accent hover:opacity-90 text-foreground font-semibold py-6 text-base">
              ...
              <Link href="#contact" className="flex-1">
                <Button
                  variant="outline"
                  className="w-full border-primary/50 hover:bg-background/50 font-semibold py-6 text-base"
                >
                  Contact Me
                </Button>
              </Link>
